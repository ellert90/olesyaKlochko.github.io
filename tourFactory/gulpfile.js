...
var paths = {
    ...
    srcHtmlcont: './src/blocks/html/contact.html',
    srcHtmlAbout: './src/blocks/html/about.html',
    srcHtmlServices: './src/blocks/html/services.html',
    srcHtmlFaq: './src/blocks/html/faq.html',
    srcImg: './src/img/*',
    ...
    destHtmlcont: './src/contact.html',
    destHtmlAbout: './src/about.html',
    destHtmlServices: './src/services.html',
    destHtmlFaq: './src/faq.html',
...
gulp.task('rigger', function () {
    gulp.src([paths.srcHtml, paths.srcHtmlcont, paths.srcHtmlAbout, paths.srcHtmlServices, paths.srcHtmlFaq])
        .pipe(rigger())
        .pipe(gulp.dest('src/'))
        .pipe(browserSync.reload({
            stream: true
...
gulp.task('watch', function () {
    ...
    gulp.watch(paths.destHtmlcont, browserSync.reload);
    gulp.watch(paths.destHtmlAbout, browserSync.reload);
    gulp.watch(paths.destHtmlServices, browserSync.reload);
    gulp.watch(paths.destHtmlFaq, browserSync.reload);
